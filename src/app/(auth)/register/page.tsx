  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gray-50">
       <form onSubmit={submit} className="bg-white p-10 rounded-2xl shadow-lg flex flex-col gap-4 w-96">
         ...
         <input type="text" placeholder="Họ Tên" required className="border p-3 rounded" value={name} onChange={e=>setName(e.target.value)} autoComplete="name" />
         ...
         <input type="password" placeholder="Mật khẩu" required className="border p-3 rounded" value={password} onChange={e=>setPassword(e.target.value)} autoComplete="new-password" />
